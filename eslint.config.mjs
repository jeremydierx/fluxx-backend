/**
 * Configuration ESLint pour le projet backend.
 *
...
export default [
  {
    files: ['**/*.js'], // Ciblez les fichiers JavaScript
    languageOptions: {
      globals: {
        ...globals.node,
        ...globals.jest // Ajouter les globales Jest
      },
      ecmaVersion: 2020,
      sourceType: 'script' // Utilisation de script pour CommonJS
    },
    rules: {
